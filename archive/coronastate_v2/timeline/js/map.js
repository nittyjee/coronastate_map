...
console.log("mapbox initial - I am here ");
...
map.on("load", function() {
    ...
    console.log("slliderVal ",sliderVal )
    console.log(map)
    $("#linkButton").on("click", function() {
        document.location.href = "raster-version.html" + urlHash;
    });
    changeDate(moment(sliderVal).unix());
});
...
function changeDate(unixDate) {
    ...
    console.log("Inside change date: ", unixDate)
    console.log("Inside change date: ", year)
    console.log("Inside change date: ", date)
    ...
    console.log("Inside change date: ", yrFilter)
    console.log("Inside change date: ", dateFilter)
...
map.on('style.load', function() {
    ...
    console.log(moment(sliderVal).unix())
    console.log(yr)
    console.log(date)
    setLayers();
    addLayers(yr, date);
